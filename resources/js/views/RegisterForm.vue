<template>
  <AuthForm title='Register'>
    <v-form class='w-100 align-center'>
      <v-text-field label='Company' type='company' v-model='company' />
      ...
      <v-text-field label='Password confirmation' type='password' v-model='passwordConfirmation'
      ...
      <v-container class='d-flex flex-wrap justify-center'>
        ...
        <router-link to='/login'>
          <v-btn variant='outlined' color='primary' class='ma-3'>Login</v-btn>
        </router-link>
      </v-container>
    </v-form>
  </AuthForm>
